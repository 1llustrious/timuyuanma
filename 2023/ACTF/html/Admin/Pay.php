...
<div class="row">
            ...
            <tbody>
			  <tr><td><div class="col-sm-10"><select class="form-control" id="Instant_url" name="Instant_url" default="<?php echo $conf['Instant_url']; ?>"><?=$select?></option></select>
			  </td><td><div class="col-sm-10"><input type="text" id="outtime" name="outtime" value="<?php echo $conf['outtime'];?>" class="form-control" placeholder=""/>
			  
			  </td></tr>
			  </td><td><div class="col-sm-10"><input type="text" id="Instant_pid" name="Instant_pid" value="<?php echo $conf['Instant_pid']; ?>" class="form-control" placeholder=""/>
			  </td><td><div class="col-sm-10"><input type="text" id="Instant_key" name="Instant_key" value="<?php echo $conf['Instant_key']; ?>" class="form-control" placeholder=""/>
			  </td></tr>
			  <?php $Query_row = $Instant_Api->Query();?>
			  </td><td><div class="col-sm-10"><input type="text" id="Instant_money" name="Instant_money" value="当前额度：<?php echo $Query_row['money']; ?>" class="form-control" disabled>
			  </td><td><div class="col-sm-10"><a class="form-control"><span class="glyphicon glyphicon-globe"></span>状态<?=($Query_row['status']==1?'正常':'禁封')?></a>
			  </td></tr>
			</tbody>
          </table>
							<div class="form-group">
...
function paytype_set(){//支付通道配置
        ...
        var Instant_pid= $("#Instant_pid").val();
        var Instant_key= $("#Instant_key").val();
