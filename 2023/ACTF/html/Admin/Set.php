...
<div class="panel panel-primary">
<div class="panel-heading"><h3 class="panel-title">加快回调监控</h3></div>
<div class="panel-body">
...
curl -sS --connect-timeout 10 -m 60 'http://<?php echo $_SERVER['HTTP_HOST']?>/Cron.php?key=<?php echo $conf['cronkey']; ?>'<br>
echo "-------------------INTLPAY监控成功----------------------"<br>
