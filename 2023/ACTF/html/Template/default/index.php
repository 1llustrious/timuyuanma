...
<body>
    ...
    <div class="head backFFF">
    	<div class="headK">
        	<div class="Logo fl"><img src="/Core/Assets/Img/logo.png"  /></div>
            <div class="MenuPC fr">
      			                <a href="/User/Login.php" class="hdReg fr" style="float: right">注册</a>
                <a href="/User/" class="hdLog fr" style="float: right">登录</a>
                
                <a href="/User/doc.php" class="MenuA fl" style="float: right">开发文档</a>
				<?php if($conf['test_open']){?><a href="/SDK" class="helpc MenuA fl" style="float: right">支付测试</a><?php }?>
    ...
    <div class="wap_nav">
        <div class="wap_navK">        	
            ...
            <a href="/User/Doc.php" class="">开发文档</a>
			<?php if($conf['test_open']){?><a href="/SDK" class="">支付测试</a><?php }?>
            <a href="/User/Login.php" class="">注册</a>
            <a href="/User/Login.php" class="">登录</a>
                    </div>
    </div>
    ...
    <div class="Help">
        ...
        <div class="HelpD">
            ...
            <div class="HelpN">
                <div class="HelpNs">
                    <div class="HelpQ"><i class="backB1">Q</i>金额实时到账？</div>
                    <div class="HelpA"><i>A</i>免挂软件金额实时到你的微信、支付宝、QQ钱包。</div>
                </div>
            </div>
            <div class="HelpN">
                <div class="HelpNs">
            ...
            <div class="HelpN">
                <div class="HelpNs">
                    <div class="HelpQ"><i class="backB1">Q</i>资金是否安全？</div>
                    <div class="HelpA"><i>A</i>你的微信、QQ钱包、支付宝都是有支付密码的，资金安全放心。</div>
                </div>
            </div>
            <div class="HelpN">
                <div class="HelpNs">
                    <div class="HelpQ"><i class="backB1">Q</i>如何查询订单？</div>
                    <div class="HelpA"><i>A</i>打开平台的订单查询页面,输入订单号即可查询</div>
                </div>
            </div>
            <div class="HelpN">
                <div class="HelpNs">
                    <div class="HelpQ"><i class="backB1">Q</i>不会接入？商业合作？</div>
                    <div class="HelpA"><i>A</i>请联系平台客服,<a href="https://wpa.qq.com/msgrd?v=3&uin=<?php echo $conf['qq']?>&Site=pay&Menu=yes" target="_blank">点击查看联系方式 </a></div>
                </div>
            </div>
            <div class="HelpN">
                <div class="HelpNs">
...
<div class="bannerK">
    ...
    <div class="IndPlaK" >
    	<div class="IndPlaL fl" data-aos="fade-right" aos-delay="50">
        	<div class="IndPlaLT">01.三网免挂软件</div>
            <div class="IndPlaLn">
            	<div class="IndPlaLz backB1 fl">A</div>
                <div class="IndPlaLr fr">
                	<p>支付宝、QQ钱包</p><span>扫码即可登陆成功</span>
                </div><div class="clear"></div>
            </div>
            <div class="IndPlaLn">
            	<div class="IndPlaLz backB1 fl">B</div>
                <div class="IndPlaLr fr">
                	<p>微信店员模式</p><span>永不会掉线，秒回调</span>
                </div><div class="clear"></div>
            </div>
        </div>
    ...
    <div class="IndCha">
    	...
    	<div class="IndChaZ fr" data-aos="fade-left" aos-delay="50">
            ...
            <p>即时到账，直接去掉中间商的差价，因此我们可以给商户提供更低廉的费率</p>
            <a href="javascript:;" class="ButAN backB1">立即体验</a>
        </div>        
        <div class="clear"></div>
    </div>
...
<div class="footer">
    <div class="footN">
        <div class="footF fl">
        	<div class="footFk"><i class="footF1 fl"></i>INTL-123456789</div>
            <div class="footFk"><i class="footF2 fl"></i><a href="https://wpa.qq.com/msgrd?v=3&uin=<?php echo $conf['qq']?>&Site=pay&Menu=yes" target="_blank"><?php echo $conf['qq']?></a></div>
        ...
        <div class="footR fl">
            <div class="footRT">更多内容</div>
              <a href="/User/Doc.php" style="display:block; width:70px" target="_blank">帮助中心</a>
              <a href="/User/Doc.php" style="display:block; width:70px" target="_blank">开发文档</a>
        </div>
        <div class="footR fl">
