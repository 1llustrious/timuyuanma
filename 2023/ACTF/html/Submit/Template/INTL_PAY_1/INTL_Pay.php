    ...
    <div class="o-list j_orderList" id="listPayOrderInfo">
        ...
        <div class="payment">
            <div class="pay-wxpay">
                ...
                <div class="p-w-bd" style="position:relative">
                    <div class="j_weixinInfo font-red" style="position:absolute; top: -36px;font-size: 15px;left: 130px;">付款后,等10秒页面会自动跳转,勿关闭此页面</div>
                    <div class="p-w-box">
                        <div class="pw-box-hd">
       ...
       <center>
				...
				<?php if($userrow[$type.'_pay_open']==1 and $QR_row['status']!=1)echo '<p style="color: red;font-size: 17px;word-break: keep-all;">商家账号状态未在线</p>';?>
                        ...
                        <!--p style="margin-top:8px">如果发现商家商品违规或者被骗请举报订单<a href="javascript:;" onclick="Report_prompt();"> 点此举报</a></p-->                    </div>
